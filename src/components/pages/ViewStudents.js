                ...
                <div className="card">
                    ...
                    <div className="card-body">
                        <div className="divbtn">
                            <Link to="/student/create" className="btn btn-success mb-2">Add New (+)</Link>
                        </div>
                                ...
                                {stddata &&
                                    stddata.map(item => (
                                        <tr key={item.id}>
                                            ...
                                            <td>{item.email}</td>
                                            <td>{item.phone}</td>
                                            <td><a onClick={() => { LoadEdit(item.id) }} className="btn btn-success mx-1">Edit</a>
                                                <a onClick={() => { Removefunction(item.id) }} className="btn btn-danger mx-1">Remove</a>
                                                <a onClick={() => { LoadDetail(item.id) }} className="btn btn-primary mx-1">Details</a>
                                            </td>
                                        </tr>
                                    ))
                                }
